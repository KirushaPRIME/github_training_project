...
public class StikerManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (Content == null) Content = GameObject.Find("Chat");
        float SizeTableX = GetComponent<Transform>().transform.parent.GetComponentInParent<RectTransform>().rect.width;
        ...
        foreach (Sprite sprite in sprites)
        {
            ...
            NewButtonStiker.GetComponent<RectTransform>().anchoredPosition = new Vector2(Count % 2 != 0 ? -SizeStiker / 2 : SizeStiker / 2, -Count / 2 * SizeStiker - SizeStiker/2);
            ...
            NewButtonStiker.name = "Stiker_" + Count;
            Count++;
        }
    }
    void Start()
